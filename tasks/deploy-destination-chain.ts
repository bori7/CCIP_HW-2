...
task(`deploy-destination-chain-step2`, `Enables previously deployed CrossChainNameServiceReceiver contract on the source chain`)
    ...
    .setAction(async (taskArguments: TaskArguments, hre: HardhatRuntimeEnvironment) => {
        ...
        // console.log(`ℹ️  About to start task 2`);
        await tx.wait();
